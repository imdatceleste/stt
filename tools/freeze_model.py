...
Easiest Usage:
    ...
    python freez_model.py -m <model-dir> -c <ckpt-name> [-o decoder/SparseToDense]
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", "--model_dir", type=str, default="", help="Model folder to export")
    parser.add_argument("-c", "--ckpt_name", type=str, default="", help="Model checkpoint name to restore")
    parser.add_argument("-o", "--output_node_names", type=str, default="decoder/SparseToDense", help="The name of the output nodes, comma separated.")
